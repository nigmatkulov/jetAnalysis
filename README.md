...
- `notebooks/07_dijet_data_vs_mc.ipynb`: compares unit-normalized reconstructed-data, reconstructed-MC, and generator-level-MC dijet pTave spectra for each configured jet-eta acceptance and trigger sample.
