...
- `notebooks/07_dijet_data_vs_mc.ipynb`: compares unit-normalized nominal reconstructed-data, eta-dependent JER-default reconstructed-MC (`hRecoDijetPtEtaCMJerDefExtra`), and nominal generator-level-MC dijet pTave spectra for each configured jet-eta acceptance and trigger sample.
